<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar header-bar ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand ml-2" href="index.php"><img src="images/icon.png" width="40">  HPK</a>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item mr-3"><a href="product.php" class="nav-link">HPK store</a></li>
